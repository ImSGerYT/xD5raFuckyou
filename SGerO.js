...
^credits
** ⇏ لعرض نقودك في البوتّّ**

^level
** ⇏ لعرض مستواك في البوت
 ...
 **
رابط البوت :https://goo.gl/F3VUY6
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
supportرابط سيرفر ال  | https://discord.gg/CrWur79
 **
`);
  message.author.sendEmbed(embed);
   }
...
//MzgxNzczNTQxMTM5MjgzOTg4.DTVw0g.fjBDFsH4Dg1740V9-3GRXSulKyQ
