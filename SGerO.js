...
client.on("message", message => {
 ...
 if (message.content === "^info") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『SGerO Bot』 『اسم البوت』", true)
      
      .addField("『^help』😘『اذا تبي جميع الاوامر مع اوامر اضافية』😵", true)
      
	    .addField("『^helpG』👻『اذا تبي الاوامر العامة』😳", true)
...
👑 ^ser-create『لعمل سيرفر ببضع ثواني』
...
القسم الثالث مصمم البوت | ImSGer + F4waz 
...
القسم الثالث مصمم البوت | ImSGer + fwaz 
...
client.on('guildMemberAdd', member => {
    const channel = member.guild.channels.find('name', 'welcomer');
    if (!channel) return;
    channel.send(`*** https://www.google.com.sa/search?q=welcome+!&safe=strict&rlz=1C1GCEA_enSA768SA768&source=lnms&tbm=isch&sa=X&ved=0ahUKEwiA-MPPq43aAhVBUhQKHf8jDasQ_AUICigB&biw=1902&bih=945#imgrc=iM28zubRy94YDM:***, ${member}`);
});  
